...
if (contactForm) {
  contactForm.addEventListener('submit', async function (e) {
    ...
    if (window.submitContactForm) {
      const result = await window.submitContactForm(formData);

      if (result.success) {
        contactForm.reset();
        showFormMessage('success', 'Thank you! Message sent.');
      } else {
        showFormMessage('error', 'Error sending message. Try again.');
